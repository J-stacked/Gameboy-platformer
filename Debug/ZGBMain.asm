...
;--------------------------------------------------------
	...
	C$ZGBMain.c$6$0_0$160	= .
	.globl	C$ZGBMain.c$6$0_0$160
...
_GetTileReplacement::
	...
	ld	(hl+), a
	ld	(hl), d
	C$ZGBMain.c$7$1_0$160	= .
	.globl	C$ZGBMain.c$7$1_0$160
;ZGBMain.c:7: if(current_state == StateGame) {
	ld	a, (#_current_state)
	or	a, a
	jr	NZ, 00104$
	C$ZGBMain.c$8$2_0$161	= .
	.globl	C$ZGBMain.c$8$2_0$161
;ZGBMain.c:8: if(U_LESS_THAN(255 - (UINT16)*tile_ptr, N_SPRITE_TYPES)) {
	...
	rlca
	jr	NC, 00102$
	C$ZGBMain.c$9$3_0$162	= .
	.globl	C$ZGBMain.c$9$3_0$162
;ZGBMain.c:9: *tile = 0;
	xor	a, a
	ld	(bc), a
	C$ZGBMain.c$10$3_0$162	= .
	.globl	C$ZGBMain.c$10$3_0$162
;ZGBMain.c:10: return 255 - (UINT16)*tile_ptr;
	...
	jr	00105$
00102$:
	C$ZGBMain.c$13$2_0$161	= .
	.globl	C$ZGBMain.c$13$2_0$161
;ZGBMain.c:13: *tile = *tile_ptr;
	ldhl	sp,	#0
	ld	a, (hl)
	ld	(bc), a
00104$:
	C$ZGBMain.c$16$1_0$160	= .
	.globl	C$ZGBMain.c$16$1_0$160
;ZGBMain.c:16: return 255u;
	ld	a, #0xff
00105$:
	C$ZGBMain.c$17$1_0$160	= .
	.globl	C$ZGBMain.c$17$1_0$160
;ZGBMain.c:17: }
	add	sp, #3
	C$ZGBMain.c$17$1_0$160	= .
	.globl	C$ZGBMain.c$17$1_0$160
