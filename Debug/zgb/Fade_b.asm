...
;C:/gbdk/ZGB/common/src/Fade_b.c:11: UINT8 FadeInOp(UINT16 c, UINT16 i) {
;	---------------------------------
; Function FadeInOp
; ---------------------------------
_FadeInOp::
...
;C:/gbdk/ZGB/common/src/Fade_b.c:12: return U_LESS_THAN(c, i) ? 0: (c - i);
	ld	a, e
	sub	a, c
;	spillPairReg hl
;	spillPairReg hl
...
;C:/gbdk/ZGB/common/src/Fade_b.c:13: }
	C$Fade_b.c$13$1_0$133	= .
	.globl	C$Fade_b.c$13$1_0$133
	XG$FadeInOp$0$0	= .
...
;C:/gbdk/ZGB/common/src/Fade_b.c:15: void FadeDMG(UINT8 fadeout) {
;	---------------------------------
; Function FadeDMG
; ---------------------------------
_FadeDMG::
...
;C:/gbdk/ZGB/common/src/Fade_b.c:17: UINT8* pals[] = {(UINT8*)0xFF47, (UINT8*)0xFF48, (UINT8*)0xFF49};
	ldhl	sp,	#12
	ld	a, #0x47
	ld	(hl+), a
	ld	a, #0xff
...
;C:/gbdk/ZGB/common/src/Fade_b.c:19: UINT8* c = colors;
	ld	hl, #0
	add	hl, sp
	push	hl
	ld	a, l
...
;C:/gbdk/ZGB/common/src/Fade_b.c:23: for(i = 0; i != 3; ++i) {
	ldhl	sp,	#28
	ld	(hl), #0x00
00107$:
	C$Fade_b.c$24$3_0$137	= .
	.globl	C$Fade_b.c$24$3_0$137
;C:/gbdk/ZGB/common/src/Fade_b.c:24: p = (UINT8)*(pals[i]);
	ldhl	sp,	#28
	ld	a, (hl)
	ldhl	sp,	#22
	ld	(hl+), a
...
;C:/gbdk/ZGB/common/src/Fade_b.c:25: for(j = 0; j != 8; j += 2, ++c) {
	ldhl	sp,	#27
	ld	(hl), #0x00
	ldhl	sp,	#24
	ld	a, (hl+)
...
;C:/gbdk/ZGB/common/src/Fade_b.c:26: *c = (DespRight(p, j)) & 0x3;
	ldhl	sp,	#27
	ld	c, (hl)
	ld	b, #0x00
	ldhl	sp,	#23
...
;C:/gbdk/ZGB/common/src/Fade_b.c:30: for(i = 0; i != 4; ++i) {
	ldhl	sp,	#27
	ld	(hl), #0x00
00111$:
	C$Fade_b.c$31$3_0$141	= .
	.globl	C$Fade_b.c$31$3_0$141
;C:/gbdk/ZGB/common/src/Fade_b.c:31: p = fadeout ? 3 - i : i;
	ldhl	sp,	#26
	ld	a, (hl)
	or	a, a
	jr	Z, 00115$
...
;C:/gbdk/ZGB/common/src/Fade_b.c:32: for(j = 0; j != 3; ++j) {
	ldhl	sp,	#28
	ld	(hl), #0x00
00109$:
	C$Fade_b.c$33$5_0$143	= .
	.globl	C$Fade_b.c$33$5_0$143
;C:/gbdk/ZGB/common/src/Fade_b.c:33: c = &colors[j << 2];
	ldhl	sp,	#28
	ld	a, (hl)
	ldhl	sp,	#25
	ld	(hl), a
...
;C:/gbdk/ZGB/common/src/Fade_b.c:34: *pals[j] = PAL_DEF(FadeInOp(c[0], p), FadeInOp(c[1], p), FadeInOp(c[2], p), FadeInOp(c[3], p));
	ldhl	sp,	#28
	ld	a, (hl)
	ldhl	sp,	#24
	ld	(hl+), a
...
;C:/gbdk/ZGB/common/src/Fade_b.c:36: delay(50);
	ld	de, #0x0032
	call	_delay
...
;C:/gbdk/ZGB/common/src/Fade_b.c:38: }
	add	sp, #29
	C$Fade_b.c$38$2_0$135	= .
	.globl	C$Fade_b.c$38$2_0$135
	XG$FadeDMG$0$0	= .
...
;C:/gbdk/ZGB/common/src/Fade_b.c:40: void FadeInDMG() {
;	---------------------------------
; Function FadeInDMG
; ---------------------------------
_FadeInDMG::
...
;C:/gbdk/ZGB/common/src/Fade_b.c:41: FadeDMG(0);
	xor	a, a
	C$Fade_b.c$42$1_0$144	= .
	.globl	C$Fade_b.c$42$1_0$144
;C:/gbdk/ZGB/common/src/Fade_b.c:42: }
	C$Fade_b.c$42$1_0$144	= .
	.globl	C$Fade_b.c$42$1_0$144
	XG$FadeInDMG$0$0	= .
...
;C:/gbdk/ZGB/common/src/Fade_b.c:44: UWORD UpdateColor(UINT8 i, UWORD col) {
;	---------------------------------
...
;C:/gbdk/ZGB/common/src/Fade_b.c:46: return RGB2(PAL_RED(col) | DespRight(0x1F, 5 - i), PAL_GREEN(col) | DespRight(0x1F, 5 - i), PAL_BLUE(col) | DespRight(0x1F, 5 - i));
	ld	a, d
	ld	(hl-), a
	ld	a, (hl)
	and	a, #0x1f
...
;C:/gbdk/ZGB/common/src/Fade_b.c:47: }
	add	sp, #4
	C$Fade_b.c$47$1_0$146	= .
	.globl	C$Fade_b.c$47$1_0$146
	XG$UpdateColor$0$0	= .
...
;C:/gbdk/ZGB/common/src/Fade_b.c:49: void FadeStepColor(UINT8 i) {
;	---------------------------------
...
;C:/gbdk/ZGB/common/src/Fade_b.c:53: UWORD* col = ZGB_Fading_BPal;
	C$Fade_b.c$54$2_0$148	= .
	.globl	C$Fade_b.c$54$2_0$148
;C:/gbdk/ZGB/common/src/Fade_b.c:54: UWORD* col_s = ZGB_Fading_SPal;
	C$Fade_b.c$56$5_0$152	= .
	.globl	C$Fade_b.c$56$5_0$152
;C:/gbdk/ZGB/common/src/Fade_b.c:56: for(pal = 0; pal < 8; pal ++) {
	ld	(hl+), a
...
;C:/gbdk/ZGB/common/src/Fade_b.c:57: for(c = 0; c < 4; ++c, ++col, ++col_s) {
00109$:
	ldhl	sp,	#20
	xor	a, a
	ld	(hl+), a
...
;C:/gbdk/ZGB/common/src/Fade_b.c:58: palette[c] = UpdateColor(i, *col);
	ldhl	sp,	#20
	ld	a, (hl)
	ld	c, #0x00
	add	a, a
...
;C:/gbdk/ZGB/common/src/Fade_b.c:59: palette_s[c] = UpdateColor(i, *col_s);
	push	hl
	ld	hl, #10
	add	hl, sp
	ld	e, l
...
;C:/gbdk/ZGB/common/src/Fade_b.c:61: set_bkg_palette(pal, 1, palette);
	inc	hl
	ld	a, (hl+)
	ld	c, a
	ld	a, (hl+)
...
;C:/gbdk/ZGB/common/src/Fade_b.c:64: delay(20);
	ld	de, #0x0014
	call	_delay
	C$Fade_b.c$65$1_0$148	= .
	.globl	C$Fade_b.c$65$1_0$148
;C:/gbdk/ZGB/common/src/Fade_b.c:65: }
	add	sp, #25
	C$Fade_b.c$65$1_0$148	= .
	.globl	C$Fade_b.c$65$1_0$148
...
;C:/gbdk/ZGB/common/src/Fade_b.c:67: void FadeInCOLOR() {
;	---------------------------------
...
;C:/gbdk/ZGB/common/src/Fade_b.c:69: for(i = 0; i != 6; i ++) {
	ld	c, #0x00
00102$:
	C$Fade_b.c$70$3_0$155	= .
	.globl	C$Fade_b.c$70$3_0$155
;C:/gbdk/ZGB/common/src/Fade_b.c:70: FadeStepColor(i);	
	push	bc
	ld	a, c
	call	_FadeStepColor
	pop	bc
...
;C:/gbdk/ZGB/common/src/Fade_b.c:72: }
	C$Fade_b.c$72$2_0$154	= .
	.globl	C$Fade_b.c$72$2_0$154
	XG$FadeInCOLOR$0$0	= .
...
;C:/gbdk/ZGB/common/src/Fade_b.c:74: void FadeIn_b() BANKED{
;	---------------------------------
; Function FadeIn_b
; ---------------------------------
	b_FadeIn_b	= 1
...
;C:/gbdk/ZGB/common/src/Fade_b.c:80: FadeInDMG();
	C$Fade_b.c$81$1_0$156	= .
	.globl	C$Fade_b.c$81$1_0$156
;C:/gbdk/ZGB/common/src/Fade_b.c:81: }
	C$Fade_b.c$81$1_0$156	= .
	.globl	C$Fade_b.c$81$1_0$156
	XG$FadeIn_b$0$0	= .
...
;C:/gbdk/ZGB/common/src/Fade_b.c:83: void FadeOutDMG() {
;	---------------------------------
; Function FadeOutDMG
; ---------------------------------
_FadeOutDMG::
...
;C:/gbdk/ZGB/common/src/Fade_b.c:84: FadeDMG(1);
	ld	a, #0x01
	C$Fade_b.c$85$1_0$157	= .
	.globl	C$Fade_b.c$85$1_0$157
;C:/gbdk/ZGB/common/src/Fade_b.c:85: }
	C$Fade_b.c$85$1_0$157	= .
	.globl	C$Fade_b.c$85$1_0$157
	XG$FadeOutDMG$0$0	= .
...
;C:/gbdk/ZGB/common/src/Fade_b.c:87: void FadeOutColor() {
;	---------------------------------
...
;C:/gbdk/ZGB/common/src/Fade_b.c:89: for(i = 5; i != 0xFF; -- i) {
	ld	c, #0x05
00102$:
	C$Fade_b.c$90$3_0$160	= .
	.globl	C$Fade_b.c$90$3_0$160
;C:/gbdk/ZGB/common/src/Fade_b.c:90: FadeStepColor(i);	
	push	bc
	ld	a, c
	call	_FadeStepColor
	pop	bc
...
;C:/gbdk/ZGB/common/src/Fade_b.c:92: }
	C$Fade_b.c$92$2_0$159	= .
	.globl	C$Fade_b.c$92$2_0$159
	XG$FadeOutColor$0$0	= .
...
;C:/gbdk/ZGB/common/src/Fade_b.c:94: void FadeOut_b() BANKED{
;	---------------------------------
; Function FadeOut_b
; ---------------------------------
	b_FadeOut_b	= 1
...
;C:/gbdk/ZGB/common/src/Fade_b.c:100: FadeOutDMG();
	C$Fade_b.c$101$1_0$161	= .
	.globl	C$Fade_b.c$101$1_0$161
;C:/gbdk/ZGB/common/src/Fade_b.c:101: }
	C$Fade_b.c$101$1_0$161	= .
	.globl	C$Fade_b.c$101$1_0$161
	XG$FadeOut_b$0$0	= .
